...
export const config = {
    matcher: [
         ...
         */
        "/((?!_next/static|_next/image|favicon\\.ico|sitemap\\.xml|robots\\.txt|manifest\\.json|sw\\.js|workbox-.*|icon-.*\\.png|.*\\.(?:svg|png|jpg|jpeg|webp|gif|ico|woff2?|css|js)|icons/|images/|assets/).*)",
    ],
};
