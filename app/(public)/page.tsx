    ...
    return (
        <>
            ...
            <section className="relative overflow-hidden px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
                {(() => {
                    // Determine if it's day or night in Olongapo (GMT+8)
                    const now = new Date();
                    // Get hour in PHT (Asia/Manila)
                    const phtHour = parseInt(now.toLocaleString("en-US", {
                        hour: "numeric",
                        hour12: false,
                        timeZone: "Asia/Manila",
                    }));

                    const isDay = phtHour >= 6 && phtHour < 18;
                    const backgroundImage = isDay ? "/background_day.webp" : "/background_night.png";
