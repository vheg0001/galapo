...
const ICON_NAMES = [
    ...
    "Globe", "Clock", "Calendar", "Camera", "Coffee", "Utensils", "ShoppingBag",
    "ShoppingCart", "Car", "Truck", "Home", "Hotel", "Hospital", "Stethoscope",
    "GraduationCap", "BookOpen", "Music", "Dumbbell", "Scissors", "Wrench",
    "Hammer", "PaintBrush", "Laptop", "Monitor", "Wifi", "CreditCard", "DollarSign",
    "Banknote", "Receipt", "FileText", "Shield", "Award", "Trophy", "Users",
    "User", "Briefcase", "Factory", "Warehouse", "TreePine", "Leaf", "Flame",
    "Zap", "Sparkles", "Crown", "Diamond", "Gem", "Gift", "Package",
    "Plane", "Ship", "Train", "Bus", "Bike", "Motorcycle", "Fuel",
    "Pizza", "Beef", "Fish", "Salad", "IceCream", "Cake", "Wine", "Beer",
    "Baby", "Pet", "Dog", "Cat", "Flower", "Garden", "Church", "Mosque",
    "Scale", "Gavel", "Landmark", "Library", "Theater", "Gamepad2", "Tv",
    "Aperture", "Palette", "Mic", "Radio", "Headphones", "Printer", "Tool",
];
